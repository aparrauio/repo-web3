 ...
 * data/personajes.ts
 * -------------------
 * "Base de datos" en memoria. En una app real esto vendría de MongoDB
 * (Semana 5) — por ahora, un arreglo mutable nos permite practicar el
 * patrón de capas (rutas -> controladores -> servicios) sin depender de
